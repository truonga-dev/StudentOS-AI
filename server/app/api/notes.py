...
async def list_notes(user_id: str = Depends(get_user_id), sb: Client = Depends(get_user_supabase)):
...
async def get_note(note_id: str, user_id: str = Depends(get_user_id), sb: Client = Depends(get_user_supabase)):
...
async def create_note(body: NoteCreate, user_id: str = Depends(get_user_id), sb: Client = Depends(get_user_supabase)):
    """Tạo ghi chú mới."""
...
async def delete_note(note_id: str, user_id: str = Depends(get_user_id), sb: Client = Depends(get_user_supabase)):
    """Xóa ghi chú."""
